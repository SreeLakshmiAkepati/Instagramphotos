...
public class Instagram {
    ...
    public Instagram(Context context, String clientId, String clientSecret, String redirectUri) {
       ...
       mRedirectUri	= redirectUri;
        ...
        String tokenUrl=Cons.ACCESS_TOKEN_URL + "?client_id=" + mClientId + "&client_secret=" + mClientSecret + "&redirect_uri=" + redirectUri + "&grant_type=authorization_code";

        mSession		= new InstagramSession(context);

        mDialog 		= new InstagramDialog(context, authUrl, mRedirectUri, new InstagramDialog.InstagramDialogListener() {
